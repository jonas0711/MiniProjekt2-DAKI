...
from crown_detect_template import detect_crowns_positions  # Template matching

# Standardstier
MODEL_FILE = "kingdomino_terrain_model.pkl"
DEFAULT_IMAGE_PATH = "KingDominoDataset/KingDominoDataset/Cropped and perspective corrected boards/19.jpg"
